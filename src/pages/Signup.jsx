  ...
  const handleLogin = () => {
    ...
    return (
        ...
        <div className="mb-4">
            ...
            <input name="first_name" value={first_name} onChange={e => handlingInput(e)} className="shadow appearance-none border rounded w-full py-2 px-8 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="First name"/>
        </div><div className="mb-4">
            <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="lastname">
            Last Name
            </label>
            <input name="last_name" value={last_name} onChange={e => handlingInput(e)} className="shadow appearance-none border rounded w-full py-2 px-8 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="last Name"/>
        </div>
        <div className="mb-4">
        ...
        <div className="mb-6">
            ...
            <input name="password1" value={password1} onChange={e => handlingInput(e)} className="shadow appearance-none border border-500 rounded w-full py-2 px-8 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="password1" type="password" placeholder="******************"/>
